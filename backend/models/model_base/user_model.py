...
class User(db.Model):
    ...
    school_class = db.Column(
        db.String(50), nullable=False, default="Unassigned")
    ...
    def rotate_key(self):
        ...
        db.session.commit()
        result_object = {'session_key': reversible_hasher(
            self.session_key, self.secret_key), 'secret_key': self.secret_key, 'updated_at': self.key_updated_at}
